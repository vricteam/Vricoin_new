Contributing to Vricoin Core
============================

The Vricoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Vricoin Core project, and is not to be
confused with overall Vricoin Network Protocol consensus changes.

Whether a pull request is merged into Vricoin Core rests with the project merge
...
Patches that change Vricoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Vricoin consensus, it must have been
...
The project leader is the release manager for each Vricoin Core release.
