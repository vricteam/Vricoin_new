...
RESOURCES += src/qt/vricoin.qrc src/qt/vricoin_locale.qrc

TRANSLATIONS += src/qt/locale/vricoin_bg.ts \
                src/qt/locale/vricoin_de.ts \
                src/qt/locale/vricoin_en.ts \
                src/qt/locale/vricoin_es.ts \
                src/qt/locale/vricoin_fi.ts \
                src/qt/locale/vricoin_fr.ts \
                src/qt/locale/vricoin_it.ts \
                src/qt/locale/vricoin_ja.ts \
                src/qt/locale/vricoin_pl.ts \
                src/qt/locale/vricoin_pt.ts \
                src/qt/locale/vricoin_ru.ts \
                src/qt/locale/vricoin_sk.ts \
                src/qt/locale/vricoin_sv.ts \
                src/qt/locale/vricoin_vi.ts \
                src/qt/locale/vricoin_zh_CN.ts \
                src/qt/locale/vricoin_zh_TW.ts
