...
In order to support loading of multiple wallets in vricoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is vricoin.cpp.
...
Changes to vricoin.cpp
----------------------
vricoin.cpp is the entry point into vricoin-qt, and as such, will require some minor modifications to provide hooks for
