...
* WebSocket: [https://github.com/Vricoin-Core/insight-api-vricoin#web-socket-api](https://github.com/Vricoin-Core/insight-api-vricoin#web-socket-api)
* API: [https://github.com/Vricoin-Core/insight-api-vricoin#swifttx-transactions](https://github.com/Vricoin-Core/insight-api-vricoin#swifttx-transactions)
...
By default, the Vricoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Vricoin Core daemon:
