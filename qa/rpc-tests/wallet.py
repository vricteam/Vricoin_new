...
#   c) node1 mines 32 blocks, so now node 0 has 60001vricoin, node 1 has 4250vricoin, node2 has none.
#   d) node0 sends 601 vricoin to node2, in two transactions (301 vricoin, then 300 vricoin).
