...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256("00000d9dc3ba521a7557585ceeecab0e1a328fe6b678bc30c8ffd41ac40d6f7e"))
                              ;

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1548916268, // * UNIX timestamp of last checkpoint block
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("vricoin.net", "seed01.vricoin.net"));     // Primary DNS Seeder
        ...
        nStartMasternodePayments = 1548916268; //Fri, 09 Jan 2015 21:05:58 GMT
    }
    const Checkpoints::CCheckpointData& Checkpoints() const
    {
        return dataTestnet;
