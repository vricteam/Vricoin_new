 ...
 * Vricoin system. There are three: the main network on which people trade goods
...
public:
    ...
    // const std::vector<unsigned char>& VricoinDevKey() const { return vVricoinDevKey; }
    // const std::vector<unsigned char>& VricoinFundKey() const { return vVricoinFundKey; }
...
protected:
    ...
    // std::vector<unsigned char> vVricoinDevKey;
    // std::vector<unsigned char> vVricoinFundKey;
    // int nDevFee;
    // int nFundFee;
    int nDefaultPort;
