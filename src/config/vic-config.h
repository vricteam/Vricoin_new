/* src/config/vricoin-config.h.  Generated from vricoin-config.h.in by configure.  */
/* src/config/vricoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef Vricoin_CONFIG_H

#define Vricoin_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.vricoin.net"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Vricoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Vricoin Core 1.0.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "vricoin"
