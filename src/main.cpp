...
#if defined(NDEBUG)
#error "Vricoin cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in uvricoin) are considered zero fee (for relaying and mining)
...
int64_t GetMasternodePayment(int nHeight, unsigned mnlevel, int64_t blockValue)
{
    ...
    {
        case 1:
            return blockValue * 0.18;

        case 2:
            return blockValue * 0.27;
