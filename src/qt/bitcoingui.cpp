...
QFontDatabase::addApplicationFont(":/fonts/vricoin_font");

QString windowTitle = tr("Vricoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Vricoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Vricoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Vricoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Vricoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Vricoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Vricoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Vricoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a Vricoin: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Vricoin Core help message to get a list with possible Vricoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Vricoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Vricoin network", "", count));
}
...
{
    QString strTitle = tr("Vricoin Core"); // default title
