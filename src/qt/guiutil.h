...
/** Utility functions used by the Vricoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Vricoin addresses in monospace font
...
// Parse "vricoin:" URI into recipient object, return true on successful parsing
