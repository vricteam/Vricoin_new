...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::VIC);
...
// Wallet
    ...
    if (settings.contains("nAnonymizePrjAmount"))
        SoftSetArg("-anonymizevricoinamount", settings.value("nAnonymizePrjAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in vricoin.cpp during shotdown to also remove the window positions
