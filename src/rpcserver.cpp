...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Vricoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Vricoin features */
        {"vricoin", "masternode", &masternode, true, true, false},
        {"vricoin", "listmasternodes", &listmasternodes, true, true, false},
        {"vricoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"vricoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"vricoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"vricoin", "masternodedebug", &masternodedebug, true, true, false},
        {"vricoin", "startmasternode", &startmasternode, true, true, false},
        {"vricoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"vricoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"vricoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"vricoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"vricoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"vricoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"vricoin", "mnsync", &mnsync, true, true, false},
        {"vricoin", "spork", &spork, true, true, false},
        {"vricoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"vricoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use vricoind, or the -server option to vricoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> vricoin-cli " + methodname + " " + args + "\n";
}
