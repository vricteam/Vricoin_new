...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Vricoin Core vricoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  vricoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Vricoin transaction") + "\n" +
                               "  vricoin-tx [options] -create [commands]   " + _("Create hex-encoded Vricoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded Vricoin transaction
